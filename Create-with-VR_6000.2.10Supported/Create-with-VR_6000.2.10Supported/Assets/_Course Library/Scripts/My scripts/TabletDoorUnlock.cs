...
public class TabletDoorUnlock : MonoBehaviour
{
    [Header("Door")]
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        TabletController tablet = other.GetComponentInParent<TabletController>();
    ...
    private void OpenDoor()
    {
        ...
        Debug.Log("Door opened with unlocked tablet.");
    }
    ...
    private void ShowLockedFeedback()
    {
        ...
        Debug.Log("Tablet is locked. Door will not open.");
    }
}